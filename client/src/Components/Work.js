    ...
    return (
        <div id="workbody">
           ...
           <br></br>
            ...
            <div id="experience">
                <p7>Currently (and most importantly), I am working full time to complete a 12 week, 600 hour intensive web development bootcamp with instruction on HTML, CSS, Javascript, React, and databases supplemented by challenging weekly projects and culminating with a capstone project.
                    </p7>
                <br></br>
                <br></br>
