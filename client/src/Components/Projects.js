...
export default function Projects(props) {
    ...
    return (
        <div id="project-head" >
            <br></br>
            <div id="title">Check out what I've made so far...</div>
            <div id="project-content">
                ...
                <div id="project-body">
                    ...
                    <a className="git-link" href="https://github.com/BurlingtonCodeAcademy/yelpington-JenaDurell" target="_blank">Yelpington </a> <a className="git-link" href="https://jena-durell-yelpington.herokuapp.com/" target="_blank">Click here to try Yelpington yourself!</a>
